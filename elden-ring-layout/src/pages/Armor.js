    ...
    return (
        ...
        <div id="Armor" class="columns">
            <section class="one">
                ...
                <div>
                    <p>Verdigris Set</p>
                    <div><img id="smallImage" src="images/Armor/verdigris-set.png"/></div>
                    <p>The Verdigris Set in Elden Ring is a light armor covered in tarnished green and copper hues. It offers moderate protection while prioritizing mobility, making it ideal for agile fighters. The set has an eerie, weathered look, as if corroded over time. Despite its fragile appearance, it provides decent resistance to elemental damage.</p>
                </div>
            </section>
            <section class="one">
                <p>General Radahn’s Set</p>
                <div><img id="bigImage" src="images/Armor/radahn_set.png"/></div>
        ...
        <div id="Armor" class="columns">
            <section class="one">
                <div id="sep">
                    <p>Blaidd's Set</p>
                    <div><img id="smallImage" src="images/Armor/blaidd'set.png"/></div>
                    <p>The Blaidd Set in Elden Ring is a stylish and rugged armor worn by Blaidd, the half-wolf warrior. Made from sturdy leather and fur, the set balances decent protection with mobility, perfect for agile combatants. Its distinct wolf-themed design reflects Blaidd’s wild, untamed nature, while offering moderate resistance to physical and elemental damage. The set’s sleek and primal look complements those who favor quick, relentless strikes.</p>
                </div>
                <div>
                    <p>Black Knife Set</p>
                    <div><img id="smallImage" src="images/Armor/black_knife_armor.png"/></div>
                    <p>The Black Knife Set in Elden Ring is a lightweight, stealth-focused armor worn by the assassins of the Black Knife clan. Cloaked in black with a tattered veil, it enhances agility and stealth, making it ideal for sneaking past enemies. While offering low physical defense, it provides excellent resistance to magic. The set’s ominous design reflects the shadowy nature of its wearers, perfect for players who prefer silent, deadly approaches in battle.</p>
                </div>
            </section>
            <section class="one">
                <p>Hoslow's Set</p>
                <div><img id="bigImage" src="images/Armor/hoslow-set.png"/></div>
        ...
        <div id="Armor" class="columns">
            <section class="one">
                <div id="sep">
                    <p>Royal Remain's set</p>
                    <div><img id="smallImage" src="images/Armor/royal_remains_set.png"/></div>
                    <p>The Royal Remains Set in Elden Ring is a somber armor associated with the remnants of royalty. Dressed in dark, tattered robes and a distinctive crown, this set offers moderate protection while enhancing resilience against death and decay. The unique design symbolizes the fall of a once-great lineage, evoking a sense of melancholy. With its focus on both defense and restoring health over time, it suits those who embrace the darker aspects of the game’s lore.</p>
                </div>
                <div>
                    <p>Drake Knight set</p>
                    <div><img id="smallImage" src="images/Armor/drake_knight_set.png" /></div>
                    <p>The Drake Knight Set in Elden Ring is a formidable armor worn by the fearsome Drake Knights, known for their mastery of both sword and sorcery. Crafted from tough scales and metal, the set provides excellent physical defense while showcasing a draconic aesthetic. Its distinctive helmet features a horned design, adding to the knightly presence. This armor is well-suited for those who seek a balance of strength and magical prowess, making it a versatile choice for various combat styles.</p>
                </div>
            </section>
            <section class="one">
                <p>War Surgeon Set</p>
                <div><img id="bigImage"src="images/Armor/war_surgeon_set.png"/></div>
        ...
        <div id="Armor" class="columns">
            <section class="one">
                <div id="sep">
                    ...
                    <div><img id="smallImage" src="images/Armor/haligtree_set.png"/></div>
                    <p>The Haligtree Knight Set in Elden Ring is an elegantly crafted armor worn by the elite knights of the Haligtree. Featuring intricate floral motifs and a striking silver finish, it balances poise and defense, making it suitable for both offense and defense. The set offers strong resistance to physical and magical attacks, embodying the grace and strength of the Haligtree’s guardians.</p>
                </div>
                <div>
                    <p>Ruler's Set</p>
                    <div><img id="smallImage" src="images/Armor/ruler-set.png" /></div>
                    <p>The Ruler's Armor in Elden Ring is a majestic set worn by those of noble lineage. This imposing armor features ornate designs and a regal cape, symbolizing authority and power. While it offers solid protection, its true strength lies in enhancing the wearer's abilities, particularly in boosting their resilience in battle. The Ruler's Armor is perfect for players who want to combine style with formidable defense, embodying the essence of a commanding presence on the battlefield.</p>
                </div>
            </section>
            <section class="one">
                <p>Haligtree Soldier Set</p>
                <div><img id="bigImage" src="images/Armor/haligtree_knight_set.png"/></div>
