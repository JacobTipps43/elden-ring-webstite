...
const StrengthTalismans = () => {
    ...
    useEffect(() => {
        const fetchTalismans = async () => {
            try {
                const response = await axios.get("https://elden-ring-backend-07b0.onrender.com/api/talismans/mageTalismans");
    ...
    return (
        ...
        <button id="add-mage-talismans" onClick={openAddDialog}>
            +
            </button>
